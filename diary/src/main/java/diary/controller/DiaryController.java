...
public class DiaryController {
	 ...
	 * @return resources/templates/list.html
	 */
	@PostMapping(path = { "/diary/insert", "/diary/form", "/diary/update" }, params = "back")
	 ...
	 * @return
	 */
	@PostMapping(path = "/diary/insert", params = "insert")
	...
	* @return
	*/
	@PostMapping(path = "/diary/update", params = "update")
